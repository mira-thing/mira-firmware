...
cat > "$ROOTFS_PATH"/etc/NetworkManager/system-connections/usb1.nmconnection << EOF
[connection]
id=usb1
type=ethernet
interface-name=usb1
...
method=disabled
EOF
chmod 600 "$ROOTFS_PATH"/etc/NetworkManager/system-connections/usb1.nmconnection
